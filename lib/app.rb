		...
		def make_brands_section
			...
			def print_info
				...
				def get_brand_info(brand)
					...
					{name: brand, stock: get_stock(brand), average_price: get_average(brand), revenue: get_revenue(brand) }
				end
				...
				def print_brand_info(brand)
					...
					puts "stock: #{brand[:stock]}"
					# Calculate and print the average price of the brand's toys
					puts "average price: #{brand[:average_price]}"
					# Calculate and print the total revenue of all the brand's toy sales combined
					puts "revenue: #{brand[:revenue]}$"	
					separator
				end
